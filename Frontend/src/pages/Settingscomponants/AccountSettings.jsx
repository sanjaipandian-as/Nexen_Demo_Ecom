    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center gap-2 sm:gap-3 pb-4 sm:pb-6 border-b border-gray-100">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#E91E63]/10 rounded-lg sm:rounded-xl flex items-center justify-center">
                    <FaUser className="w-5 h-5 sm:w-6 sm:h-6 text-[#E91E63]" />
                </div>
                <div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6">
                <div>
                    <label className={labelClasses}>
                        <FaUser className="inline mr-2 text-[#E91E63]" />
                        Full Name
                    </label>
                    <input
                        type="text"
                ...
                <div className="md:col-span-2">
                    <label className={labelClasses}>
                        <FaEnvelope className="inline mr-2 text-[#E91E63]" />
                        Email Address
                    </label>
                    <input
                        type="email"
                ...
                <div className="md:col-span-2">
                    <label className={labelClasses}>
                        <FaPhone className="inline mr-2 text-[#E91E63]" />
                        Phone Number
                    </label>
                    <input
                        type="tel"
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                {!isEditingProfile ? (
                    <button
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-[#E91E63] to-[#E91E63]/90 text-white font-semibold rounded-xl hover:from-[#E91E63] hover:to-[#E91E63]/80 transition-all shadow-lg shadow-[#E91E63]/30"
                    >
            ...
            <div className="pt-6 border-t border-gray-100">
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 bg-[#E91E63]/10 rounded-lg flex items-center justify-center">
                        <FaKey className="w-5 h-5 text-[#E91E63]" />
                    </div>
                        ...
                        <form onSubmit={handleChangePassword} className="space-y-6">
                            ...
                            <div className="flex gap-3 pt-4">
                                <button
                                    type="submit"
                                    disabled={saving}
                                    className="flex-1 px-6 py-3 bg-gradient-to-r from-[#E91E63] to-[#E91E63]/90 text-white font-semibold rounded-xl hover:from-[#E91E63] hover:to-[#E91E63]/80 transition-all shadow-lg shadow-[#E91E63]/30 disabled:opacity-50"
                                >
