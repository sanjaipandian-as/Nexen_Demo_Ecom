...
const Adminlogin = () => {
    ...
    if (!gatekeeperPassed) {
        return (
            <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 md:p-6 font-body relative overflow-hidden">
                ...
                <div className="w-full max-w-sm relative z-10 animate-slideUp">
                    <div className="text-center mb-8 md:mb-10">
                        ...
                        <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight font-hero mb-2">Restricted Access</h2>
                        <p className="text-slate-400 font-medium text-xs md:text-sm">Authorized personnel only.</p>
                    </div>
                    ...
                    <form onSubmit={handleGatekeeperSubmit} className="space-y-4">
                        <div className="relative group">
                            <input
                                ...
                                className="w-full px-5 py-4 md:px-6 md:py-5 bg-slate-800/50 border border-slate-700/50 rounded-2xl focus:bg-slate-800 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/10 outline-none text-white text-center font-bold tracking-widest placeholder:text-slate-600 transition-all duration-300 backdrop-blur-md text-sm md:text-base"
                                required
                            />
                        </div>
                        <button
        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 md:p-6 font-body">
            <div className="w-full max-w-[400px] animate-slideUp">
                ...
                <div className="text-center mb-8 md:mb-10">
                    ...
                    <h1 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight font-hero mb-2">Admin Portal</h1>
                    <p className="text-slate-500 font-medium text-xs md:text-sm">Sign in to manage your store.</p>
                </div>

                {/* Card */}
                <div className="bg-white p-6 md:p-8 rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-slate-100">
